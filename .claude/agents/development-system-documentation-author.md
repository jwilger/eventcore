---
name: development-system-documentation-author
description: Development System documentation-author role; read-only because Claude privileged-subagent MCP isolation is unavailable.
