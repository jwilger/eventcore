---
name: development-system-verifier
description: Development System verifier role; read-only because Claude privileged-subagent MCP isolation is unavailable.
