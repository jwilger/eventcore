---
name: development-system-system-diagnostician
description: Development System system-diagnostician role; read-only because Claude privileged-subagent MCP isolation is unavailable.
