---
name: development-system-ci-recovery
description: Development System ci-recovery role; read-only because Claude privileged-subagent MCP isolation is unavailable.
