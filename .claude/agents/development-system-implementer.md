---
name: development-system-implementer
description: Development System implementer role; read-only because Claude privileged-subagent MCP isolation is unavailable.
