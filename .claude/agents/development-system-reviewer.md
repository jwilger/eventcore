---
name: development-system-reviewer
description: Development System reviewer role; read-only because Claude privileged-subagent MCP isolation is unavailable.
