---
name: development-system-coordinator
description: Development System coordinator role; read-only because Claude privileged-subagent MCP isolation is unavailable.
