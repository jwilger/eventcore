---
name: development-system-delivery
description: Development System delivery role; read-only because Claude privileged-subagent MCP isolation is unavailable.
