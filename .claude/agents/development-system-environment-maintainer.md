---
name: development-system-environment-maintainer
description: Development System environment-maintainer role; read-only because Claude privileged-subagent MCP isolation is unavailable.
