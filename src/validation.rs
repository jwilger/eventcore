...
///
/// Per ADR-017, domain types like StreamId and StreamPrefix reserve glob
/// metacharacters (*, ?, [, ]) to enable future pattern matching without
/// ambiguity or escaping complexity.
