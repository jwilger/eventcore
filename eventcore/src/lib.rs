...
pub use eventcore_types::{
    ...
    EventStreamReader, EventStreamSlice, FailureStrategy, NewEvents, Operation, Projector,
    StreamDeclarations, StreamDeclarationsError, StreamId, StreamPosition, StreamResolver,
