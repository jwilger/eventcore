...
// Backend-implementer types (EventStore, EventReader, etc.) remain in eventcore-types only.
...
// Re-export projection runtime components (public API)
pub use projection::{ProjectionError, run_projection};

// Internal imports for types used within this crate but not part of the public API
